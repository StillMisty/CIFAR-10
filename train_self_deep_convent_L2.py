...
from self_deep_convent_L2 import SelfDeepConvNetL2
...
def train_cifar10():
    ...
    network = SelfDeepConvNetL2(
        input_dim=(3, 32, 32), weight_decay_lambda=0.001, dropout_ration=0.5
    )
    ...
    # 保存训练好的模型参数
    network.save_params("results/cifar10_params-L2.pkl")
    print("别摸了，跑完了！")
